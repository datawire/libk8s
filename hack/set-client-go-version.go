...
const goModTemplateString = `// Code generated by [{{ .Self }}]. DO NOT EDIT.
...
func writeGoMod(w io.Writer, self string, version string, godep Godep) error {
...
const pinGoTemplateString = `// Code generated by [{{ .Self }}]. DO NOT EDIT.
...
func writePinGo(w io.Writer, self string, pkgs []string) error {
	tmpl := template.Must(template.
		New("pin.go").
...
func Main(arg0, version string) error {
	self := fmt.Sprintf("%s %q", arg0, version)
	...
	err = writeGoMod(goMod, self, version, godep)
	goMod.Close()
	if err != nil {
	...
	err = writePinGo(pin, self, allPkgs)
	pin.Close()
	if err != nil {
