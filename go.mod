// Code generated by [go run ./hack/set-client-go-version.go "refs/heads/release-11.0"] (for k8s.io/client-go commit 6d55c1b1f1ca8ad83d572bbc3ca55ba5526d9d71). DO NOT EDIT.
