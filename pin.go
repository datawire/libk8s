// Code generated by "/run/user/1000/tmpdir/go-build826013214/b001/exe/set-client-go-version v11.0.0" DO NOT EDIT.

package libk8s

import (
	_ "cloud.google.com/go/compute/metadata"
	_ "cloud.google.com/go/internal"
	...
	_ "golang.org/x/oauth2/internal"
	...
	_ "k8s.io/client-go/examples/create-update-delete-deployment"
	_ "k8s.io/client-go/examples/fake-client"
	_ "k8s.io/client-go/examples/in-cluster-client-configuration"
	_ "k8s.io/client-go/examples/out-of-cluster-client-configuration"
	_ "k8s.io/client-go/examples/workqueue"
	...
	_ "k8s.io/client-go/kubernetes_test"
	...
	_ "k8s.io/client-go/tools/leaderelection/example"
