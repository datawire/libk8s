// Code generated by [go run ./cmd/generate-libk8s "refs/heads/release-1.16"] (for k8s.io/kubectl commit 419760c9116d65aa06ca6b62cb7e1ba47263a2b9). DO NOT EDIT.
...
import (
	...
	_ "github.com/chai2010/gettext-go/gettext"
	_ "github.com/chai2010/gettext-go/gettext/mo"
	_ "github.com/chai2010/gettext-go/gettext/plural"
	_ "github.com/chai2010/gettext-go/gettext/po"
	_ "github.com/davecgh/go-spew/spew"
	_ "github.com/daviddengcn/go-colortext"
	_ "github.com/dgrijalva/jwt-go"
	_ "github.com/docker/distribution/digestset"
	...
	_ "github.com/mxk/go-flowrate/flowrate"
	...
	_ "k8s.io/apimachinery/pkg/api/meta/testrestmapper"
	...
	_ "k8s.io/apimachinery/pkg/util/duration"
	...
	_ "k8s.io/apimachinery/pkg/util/jsonmergepatch"
	...
	_ "k8s.io/component-base/cli/flag"
	_ "k8s.io/klog"
	_ "k8s.io/kube-openapi/pkg/common"
	_ "k8s.io/kube-openapi/pkg/util/proto"
	_ "k8s.io/kube-openapi/pkg/util/proto/testing"
	_ "k8s.io/kube-openapi/pkg/util/proto/validation"
	_ "k8s.io/kubectl/pkg/apply"
	_ "k8s.io/kubectl/pkg/apply/parse"
	_ "k8s.io/kubectl/pkg/apply/strategy"
	_ "k8s.io/kubectl/pkg/apps"
	_ "k8s.io/kubectl/pkg/cmd"
	_ "k8s.io/kubectl/pkg/cmd/annotate"
	_ "k8s.io/kubectl/pkg/cmd/apiresources"
	_ "k8s.io/kubectl/pkg/cmd/apply"
	_ "k8s.io/kubectl/pkg/cmd/attach"
	_ "k8s.io/kubectl/pkg/cmd/autoscale"
	_ "k8s.io/kubectl/pkg/cmd/certificates"
	_ "k8s.io/kubectl/pkg/cmd/clusterinfo"
	_ "k8s.io/kubectl/pkg/cmd/completion"
	_ "k8s.io/kubectl/pkg/cmd/config"
	_ "k8s.io/kubectl/pkg/cmd/create"
	_ "k8s.io/kubectl/pkg/cmd/delete"
	_ "k8s.io/kubectl/pkg/cmd/describe"
	_ "k8s.io/kubectl/pkg/cmd/diff"
	_ "k8s.io/kubectl/pkg/cmd/drain"
	_ "k8s.io/kubectl/pkg/cmd/edit"
	_ "k8s.io/kubectl/pkg/cmd/exec"
	_ "k8s.io/kubectl/pkg/cmd/explain"
	_ "k8s.io/kubectl/pkg/cmd/expose"
	_ "k8s.io/kubectl/pkg/cmd/help"
	_ "k8s.io/kubectl/pkg/cmd/kustomize"
	_ "k8s.io/kubectl/pkg/cmd/label"
	_ "k8s.io/kubectl/pkg/cmd/logs"
	_ "k8s.io/kubectl/pkg/cmd/options"
	_ "k8s.io/kubectl/pkg/cmd/patch"
	_ "k8s.io/kubectl/pkg/cmd/plugin"
	_ "k8s.io/kubectl/pkg/cmd/portforward"
	_ "k8s.io/kubectl/pkg/cmd/proxy"
	_ "k8s.io/kubectl/pkg/cmd/replace"
	_ "k8s.io/kubectl/pkg/cmd/rollingupdate"
	_ "k8s.io/kubectl/pkg/cmd/rollout"
	_ "k8s.io/kubectl/pkg/cmd/run"
	_ "k8s.io/kubectl/pkg/cmd/scale"
	_ "k8s.io/kubectl/pkg/cmd/set"
	_ "k8s.io/kubectl/pkg/cmd/set/env"
	_ "k8s.io/kubectl/pkg/cmd/taint"
	_ "k8s.io/kubectl/pkg/cmd/testing"
	_ "k8s.io/kubectl/pkg/cmd/top"
	_ "k8s.io/kubectl/pkg/cmd/util"
	_ "k8s.io/kubectl/pkg/cmd/util/editor"
	_ "k8s.io/kubectl/pkg/cmd/util/editor/crlf"
	_ "k8s.io/kubectl/pkg/cmd/util/sanity"
	_ "k8s.io/kubectl/pkg/cmd/version"
	_ "k8s.io/kubectl/pkg/cmd/wait"
	_ "k8s.io/kubectl/pkg/describe"
	_ "k8s.io/kubectl/pkg/describe/versioned"
	_ "k8s.io/kubectl/pkg/drain"
	_ "k8s.io/kubectl/pkg/explain"
	_ "k8s.io/kubectl/pkg/generate"
	_ "k8s.io/kubectl/pkg/generate/versioned"
	_ "k8s.io/kubectl/pkg/generated"
	_ "k8s.io/kubectl/pkg/metricsutil"
	_ "k8s.io/kubectl/pkg/polymorphichelpers"
	_ "k8s.io/kubectl/pkg/proxy"
	_ "k8s.io/kubectl/pkg/rawhttp"
	_ "k8s.io/kubectl/pkg/scale"
	_ "k8s.io/kubectl/pkg/scheme"
	_ "k8s.io/kubectl/pkg/util"
	_ "k8s.io/kubectl/pkg/util/certificate"
	_ "k8s.io/kubectl/pkg/util/deployment"
	_ "k8s.io/kubectl/pkg/util/event"
	_ "k8s.io/kubectl/pkg/util/fieldpath"
	_ "k8s.io/kubectl/pkg/util/hash"
	_ "k8s.io/kubectl/pkg/util/i18n"
	_ "k8s.io/kubectl/pkg/util/interrupt"
	_ "k8s.io/kubectl/pkg/util/logs"
	_ "k8s.io/kubectl/pkg/util/openapi"
	_ "k8s.io/kubectl/pkg/util/openapi/testing"
	_ "k8s.io/kubectl/pkg/util/openapi/validation"
	_ "k8s.io/kubectl/pkg/util/podutils"
	_ "k8s.io/kubectl/pkg/util/printers"
	_ "k8s.io/kubectl/pkg/util/qos"
	_ "k8s.io/kubectl/pkg/util/rbac"
	_ "k8s.io/kubectl/pkg/util/resource"
	_ "k8s.io/kubectl/pkg/util/slice"
	_ "k8s.io/kubectl/pkg/util/storage"
	_ "k8s.io/kubectl/pkg/util/templates"
	_ "k8s.io/kubectl/pkg/util/term"
	_ "k8s.io/kubectl/pkg/validation"
	_ "k8s.io/kubectl/pkg/version"
	_ "k8s.io/metrics/pkg/apis/metrics"
	_ "k8s.io/metrics/pkg/apis/metrics/v1alpha1"
	_ "k8s.io/metrics/pkg/apis/metrics/v1beta1"
	_ "k8s.io/metrics/pkg/client/clientset/versioned"
	_ "k8s.io/metrics/pkg/client/clientset/versioned/scheme"
	_ "k8s.io/metrics/pkg/client/clientset/versioned/typed/metrics/v1alpha1"
