// Code generated by [go run ./generate-libk8s.go "refs/heads/release-1.14"] (for k8s.io/cli-runtime commit b9eb767d2e1a78b29e1f371bc476374c6cfd1849). DO NOT EDIT.

//go:generate go run ./generate-libk8s.go "refs/heads/release-1.14"
